...
export default function Header() {
	return (
		<header className='flex flex-col justify-center items-center gap-4 mb-8 box-border'>
			<Image
				...
				border-4 border-white box-border'
			/>
			<h1 className='text-4xl font-bold'>Sinval Luz</h1>
